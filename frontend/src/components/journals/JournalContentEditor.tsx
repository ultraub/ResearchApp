/**
 * Journal Content Editor - TipTap editor wrapper for journal entries
...
function parseContent(content: Record<string, unknown> | null): Record<string, unknown> {
  if (!content) {
...
export default function JournalContentEditor({
  content,
  onChange,
  onSave,
  ...
  if (!editor) {
    return (
      <div
        className="animate-pulse bg-gray-100 dark:bg-dark-card rounded-xl"
        style={{ minHeight }}
      />
    );
  }
  ...
  return (
    <div className={clsx("relative border border-gray-200 dark:border-dark-border rounded-xl overflow-hidden", className)}>
      {/* Toolbar */}
      {editable && (
        <div className="flex items-center gap-1 px-3 py-2 bg-gray-50 dark:bg-dark-elevated border-b border-gray-200 dark:border-dark-border">
          {/* Text formatting */}
          <MenuButton
      ...
      {editable && editor.isEditable && (
        <BubbleMenu
          ...
          className="flex items-center gap-0.5 bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-lg shadow-card p-1"
        >
          <MenuButton
            onClick={() => editor.chain().focus().toggleBold().run()}
            isActive={editor.isActive("bold")}
      ...
      <EditorContent
        editor={editor}
        className={clsx(
          "p-4 bg-white dark:bg-dark-base",
          ...
          "[&_.ProseMirror_h3]:text-lg [&_.ProseMirror_h3]:font-medium [&_.ProseMirror_h3]:my-3",
          ...
          "[&_.ProseMirror_blockquote]:border-l-4 [&_.ProseMirror_blockquote]:border-gray-300 [&_.ProseMirror_blockquote]:dark:border-dark-border [&_.ProseMirror_blockquote]:pl-4 [&_.ProseMirror_blockquote]:italic [&_.ProseMirror_blockquote]:text-gray-600 [&_.ProseMirror_blockquote]:dark:text-gray-400",
          "[&_.ProseMirror_pre]:bg-gray-100 [&_.ProseMirror_pre]:dark:bg-dark-elevated [&_.ProseMirror_pre]:rounded [&_.ProseMirror_pre]:p-4 [&_.ProseMirror_pre]:my-3 [&_.ProseMirror_pre]:overflow-x-auto",
          "[&_.ProseMirror_code]:bg-gray-100 [&_.ProseMirror_code]:dark:bg-dark-elevated [&_.ProseMirror_code]:rounded [&_.ProseMirror_code]:px-1 [&_.ProseMirror_code]:text-sm [&_.ProseMirror_code]:font-mono",
