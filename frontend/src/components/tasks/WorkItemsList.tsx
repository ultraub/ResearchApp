...
function WorkItemCard({
  ...
  return (
    <div
      className={clsx(
        "cursor-pointer rounded-xl border bg-white p-3 shadow-soft transition-all hover:bg-gray-50 hover:shadow-md dark:bg-dark-card dark:hover:bg-dark-elevated",
